...
namespace PTV.Developer.Clients.mapmatch.Model
{
    ...
    public partial class MatchedPath : IEquatable<MatchedPath>, IValidatableObject
    {
        ...
        /// <param name="routeId">The ID of the route for this path. It is available only if it is requested by MatchedTrackResults.ROUTE_ID. This route ID can be used as an input parameter in a calculateRoute request at the Routing API and is valid for 12 hours..</param>
        ...
        /// </summary>
        /// <value>The ID of the route for this path. It is available only if it is requested by MatchedTrackResults.ROUTE_ID. This route ID can be used as an input parameter in a calculateRoute request at the Routing API and is valid for 12 hours.</value>
