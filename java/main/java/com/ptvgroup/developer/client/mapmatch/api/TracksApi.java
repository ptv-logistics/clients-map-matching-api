    ...
    try {
      ...
      try {
        ...
        return new ApiResponse<MatchedTrackIdentifier>(
          ...
          memberVarObjectMapper.readValue(localVarResponse.body(), new TypeReference<MatchedTrackIdentifier>() {}) // closes the InputStream
    ...
    try {
      ...
      try {
        ...
        return new ApiResponse<MatchingResponse>(
          localVarResponse.statusCode(),
          localVarResponse.headers().map(),
          memberVarObjectMapper.readValue(localVarResponse.body(), new TypeReference<MatchingResponse>() {}) // closes the InputStream
