...
export interface Warning {
     ...
     * 
     * * `MAPMATCHING_SEGMENT_LOCATION_DESCRIPTORS_NOT_AVAILABLE` - There is no detailed location description available for the matched position.  
     * 
     * * `MAPMATCHING_SEGMENT_ATTRIBUTES_NOT_AVAILABLE` - There are no segment attributes available for the matched position.  
     * @type {string}
     * @memberof Warning
     */
    warningCode: string;
