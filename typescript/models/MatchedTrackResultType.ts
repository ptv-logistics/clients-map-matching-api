 ...
 * @export
 */
export const MatchedTrackResultType = {
    PATHS: 'PATHS',
    GEOMETRY: 'GEOMETRY',
...
export type MatchedTrackResultType = typeof MatchedTrackResultType[keyof typeof MatchedTrackResultType];


export function instanceOfMatchedTrackResultType(value: any): boolean {
    for (const key in MatchedTrackResultType) {
        if (Object.prototype.hasOwnProperty.call(MatchedTrackResultType, key)) {
            if (MatchedTrackResultType[key as keyof typeof MatchedTrackResultType] === value) {
                return true;
            }
        }
    }
