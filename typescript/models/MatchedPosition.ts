...
export function MatchedPositionFromJSONTyped(json: any, ignoreDiscriminator: boolean): MatchedPosition {
    ...
    return {
        ...
        'lowEmissionZones': !exists(json, 'lowEmissionZones') ? undefined : ((json['lowEmissionZones'] as Array<any>).map(LowEmissionZoneDescriptorsFromJSON)),
...
export function MatchedPositionToJSON(value?: MatchedPosition | null): any {
    ...
    return {
        ...
        'lowEmissionZones': value.lowEmissionZones === undefined ? undefined : ((value.lowEmissionZones as Array<any>).map(LowEmissionZoneDescriptorsToJSON)),
